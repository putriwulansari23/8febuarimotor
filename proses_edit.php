...
if(isset($_POST['edit'])){
    ...
    $sql="UPDATE tb_motor SET nomor_motor='$nomor_motor', merek='$merek', jenis_motor'$jenis_motor', tahun_motor='$tahun_motor', tanggal_pinjam='$tanggal_pinjam', tanggal_kembali='$tanggal_kembali' WHERE id_motor='$id'";
    $query= mysqli_query($koneksi,$sql);
